  ...
  ({ className, onClick, children, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "inline-flex items-center gap-2 rounded-full border-[1.5px] border-ink bg-card px-5 py-3 text-[14.5px] font-semibold text-ink transition-colors hover:bg-ink hover:text-cream",
          className
        )}
        {...props}
      >
...
function DropdownContent({ className, align = "left", children, ...props }: DropdownContentProps) {
  ...
  return (
    <div
      className={cn(
        "absolute z-50 mt-1.5 min-w-[180px] overflow-hidden rounded-xl border-[1.5px] border-ink bg-card shadow-flat",
  ...
  ({ className, onClick, children, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "flex w-full items-center gap-2.5 px-4 py-3 text-left text-[14.5px] font-semibold text-ink hover:bg-ink/5 active:bg-ink/10",
