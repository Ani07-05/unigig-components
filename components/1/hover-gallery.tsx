    ...
    <div className={cn("group flex items-center", className)}>
      {images.map((img, i) => (
        <div
          ...
          className={cn(
            "h-16 w-16 flex-shrink-0 overflow-hidden rounded-xl border-[1.5px] border-ink bg-cream-2 transition-all duration-300 ease-out",
            i > 0 && "-ml-6 group-hover:ml-1",
            "group-hover:scale-110 group-hover:shadow-flat"
          )}
        >
