    ...
    <div className={cn("relative", className)}>
      ...
      <div className="mt-3 flex items-center justify-center gap-4">
        <button
          ...
          onClick={() => go(-1)}
          aria-label="Previous"
          className="flex h-9 w-9 items-center justify-center rounded-full border-[1.5px] border-ink bg-card [&_svg]:h-4 [&_svg]:w-4"
        >
        ...
        <div className="flex items-center gap-1.5">
          {items.map((_, i) => (
            <button
              ...
              className={cn(
                "h-2 w-2 rounded-full border-[1.5px] border-ink transition-colors",
