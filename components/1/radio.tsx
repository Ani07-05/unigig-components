  ...
  ({ className, disabled, ...props }, ref) => {
    return (
      ...
      >
        ...
        <span
          className={cn(
            "relative flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full border-[1.5px] border-ink bg-card transition-colors",
            "after:h-2.5 after:w-2.5 after:scale-0 after:rounded-full after:bg-ink after:transition-transform",
