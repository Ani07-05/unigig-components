...
const toastVariants = cva("[&_.toast-icon]:text-ink", {
  variants: {
    variant: {
      info: "[&_.toast-icon]:text-blue",
      success: "[&_.toast-icon]:text-green",
      warning: "[&_.toast-icon]:text-mustard",
      error: "[&_.toast-icon]:text-coral",
    },
  },
...
function Toast({
  ...
  return (
    <div
      className={cn(
        "flex w-full max-w-sm items-center gap-3 rounded-xl border-[1.5px] border-ink bg-card p-4 text-[14.5px] shadow-flat transition-all duration-300 ease-out",
