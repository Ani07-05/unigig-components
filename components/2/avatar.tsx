...
const avatarVariants = cva(
  "inline-flex flex-shrink-0 items-center justify-center overflow-hidden rounded-full border border-c-line bg-c-bg-2 font-corp-mono font-semibold text-c-ink",
  {
    variants: {
      size: {
