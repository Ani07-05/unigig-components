  ...
  return (
    ...
    >
      ...
      <span
        role="tooltip"
        className={cn(
          "pointer-events-none absolute z-50 whitespace-nowrap rounded-md bg-c-ink px-3 py-2 font-corp-mono text-[12px] text-white shadow-c transition-opacity duration-150",
          sideClasses[side],
      ...
      >
        {content}
        <span className={cn("absolute h-2 w-2 rotate-45 bg-c-ink", arrowSideClasses[side])} />
      </span>
    </span>
  );
}
