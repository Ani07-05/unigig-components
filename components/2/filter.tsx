...
const filterPillVariants = cva(
  "rounded-md border border-c-line px-5 py-2.5 text-[13.5px] font-semibold transition-colors outline-none focus-visible:ring-2 focus-visible:ring-c-primary focus-visible:ring-offset-2 focus-visible:ring-offset-c-bg",
  {
    variants: {
      selected: {
        true: "border-c-primary bg-c-primary text-white",
        false: "bg-transparent text-c-ink hover:bg-c-bg-2",
      },
    },
