...
const linkVariants = cva("inline-flex items-center gap-1 transition-colors", {
  variants: {
    variant: {
      default: "text-c-ink underline underline-offset-4 hover:text-c-primary",
      muted: "text-c-ink-soft underline underline-offset-4 hover:text-c-ink",
      external: "text-c-ink underline underline-offset-4 hover:text-c-primary",
    },
  },
