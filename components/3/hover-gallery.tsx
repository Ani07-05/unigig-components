    ...
    <div className={cn("group flex items-center", className)}>
      {images.map((img, i) => (
        <div
          ...
          className={cn(
            "h-16 w-16 shrink-0 overflow-hidden rounded-[3px] border border-dl-line bg-dl-bg-2 transition-all duration-300 ease-out",
            i > 0 && "-ml-6 group-hover:ml-1",
            "group-hover:scale-110 group-hover:shadow-dl"
          )}
        >
